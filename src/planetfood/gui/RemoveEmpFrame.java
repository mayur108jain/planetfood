...
public class RemoveEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbEmpCategory.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        jcbEmpCategory.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manager", "Cashier", "Chef", "Waiter" }));
    ...
    private void btnRemoveProductActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveProductActionPerformed
         try
        {
           int ans=JOptionPane.showConfirmDialog(null,"ARE YOU SURE?","DELETE EMPLOYEE!",JOptionPane.YES_NO_OPTION);
           if(ans==JOptionPane.NO_OPTION)
               return;
           String empId=(String)jcbEmpId.getSelectedItem(); 
           if(EmpDao.removeEmp(empId))
           {
               JOptionPane.showMessageDialog(null,"Record deleted Successfully ","Deleted!",JOptionPane.INFORMATION_MESSAGE);
               jcbEmpId.removeAllItems();
           }
           else
               JOptionPane.showMessageDialog(null,"could not delete employee","Input Error!",JOptionPane.ERROR_MESSAGE);
