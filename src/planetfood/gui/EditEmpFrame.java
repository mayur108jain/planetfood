...
public class EditEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbEmpJob.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jcbEmpJob.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manager", "Cashier", "Chef", "Waiter" }));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jcbEmpJob, 0, 253, Short.MAX_VALUE)
    ...
    private void btnSaveChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveChangesActionPerformed
        try
        {
             ...
             {  
                Emp e=new Emp();
                String job=(String)jcbEmpJob.getSelectedItem();
                ...
                {
                JOptionPane.showMessageDialog(null,"Employee id not found","Error while inserting",JOptionPane.ERROR_MESSAGE);
                }  
            }
            else
            {
    ...
    private void jcbEmpJobActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbEmpJobActionPerformed
        try
        {
             ...
             job = EmpDao.getEmployeeId(jcbEmpJob.getSelectedItem().toString());
